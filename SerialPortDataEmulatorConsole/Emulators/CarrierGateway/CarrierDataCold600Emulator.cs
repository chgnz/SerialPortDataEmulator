        ...
        protected virtual byte[] GenerateResponseWithoutCRC(byte command)
        {
            switch (command)
            {
                case 0x13:
                    ...
                    //return new byte[] {
                    // 12 sensors                     
                    //    0x99, 0x93, 0x3C, 0x00, 0x01, 0x00, 0x0B, 0x00, 0xF8, 0x02, 0x00, 0x02, 0x00, 0x00, 0x03, 0x00, 0x02, 0x00, 0x00, 0x04, 0x00, 0x02, 0x00, 0x00, 0x05, 0x00, 0x02, 0x00, 0x00, 0x06, 0x00, 0x02, 0x00, 0x00, 0x07, 0x00, 0x02, 0x00, 0x00, 0x08, 0x00, 0x02, 0x00, 0x00, 0x09, 0x00, 0x02, 0x00, 0x00, 0x0A, 0x00, 0x02, 0x00, 0x00, 0x0B, 0x00, 0x02, 0x00, 0x00, 0x0C, 0x00, 0x02, 0x00, 0x00, 0xCF
                    //};
                ...
                // Device info request (device is not defined in the protocol! Command found in CPP.exe software provided by carrier)
                // based on c# app, contains device serial number and device id
                case 0x70:
                    return new byte[] {
                        0x99, 0xf0, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
